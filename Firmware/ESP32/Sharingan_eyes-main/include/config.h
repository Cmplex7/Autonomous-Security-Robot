...
// Cac loi mat (iris) bo sung, doi luc chay bang nut bam:
#include "eyes/iris_tomoe.h"    // Sharingan tomoe
#include "eyes/iris_kamui.h"    // Mangekyou Kamui (Obito)
#include "eyes/iris_sasuke.h"   // Mangekyou vinh hang (Sasuke)
#include "eyes/iris_rinnegan.h" // Rinnegan

#define IRIS_SWITCH_PIN 27      // Nut bam doi loi mat (noi GND, INPUT_PULLUP)
...
#define DISPLAY_BACKLIGHT  -1 // Pin for backlight control (-1 for none); BLK wired to 3V3
